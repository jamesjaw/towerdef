...
void SettingScene::Initialize() {
    ...
    btn = new Engine::ImageButton("start_scene/out.png", "start_scene/in.png", halfW - 200, halfH +300 , 400, 100);
    btn->SetOnClickCallback(std::bind(&SettingScene::PlayOnClick, this, 1));
    AddNewControlObject(btn);
    //
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW, halfH +350 , 0, 0, 0, 255, 0.5, 0.5));
    AddNewObject(new Engine::Label("setting", "pirulen.ttf", 108, halfW, halfH/2 , 255, 255, 0, 255, 0.5, 0.5));
