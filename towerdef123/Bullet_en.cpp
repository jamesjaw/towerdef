...
PlayScene* Bullet_en::getPlayScene() {
	return dynamic_cast<PlayScene*>(Engine::GameEngine::GetInstance().GetActiveScene());
}
void Bullet_en::OnExplode(Turret* turret) {
}
Bullet_en::Bullet_en(std::string img, float speed, float damage, Engine::Point position, Engine::Point forwardDirection, float rotation, Enemy* parent) :
...
void Bullet_en::Update(float deltaTime) {
